...
public class payFine extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int newMyFine = bean.getStudent().getMyFine() - pay;
            bean.getStudent().setMyFine(newMyFine);
            String id = bean.getStudent().getID();
            db.payFine(id, newMyFine);
             session.setAttribute("bean", bean);
            RequestDispatcher dis = request.getRequestDispatcher("SuccessfullPage.jsp?payFine=");
